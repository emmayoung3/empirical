...
*a ttest measuring the difference in approval based on shutdown yields insignificant results*
ttest approval, by(shutdown)

*a ttest measuring differene in approval based on before the shutdown happened (=1) and during/after
*in this ttest, we see that approval was significantly higher before the longest gov shutdown in American history*

*we can conclude that the occurance of this shutdown made a significant impact*
...
esttab using approval.html, se r2 ar2 scalar(rmse) replace
